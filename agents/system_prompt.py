...
def build_agent_system_prompt(agent: Agent) -> str:
    return (
        ...
        "Orden: (1) create_journal_entry con el texto completo o fiel, (2) create_transaction / log_exercise / "
        "log_habit_completion según detectes datos concretos, (3) responde en un párrafo breve.\n"
